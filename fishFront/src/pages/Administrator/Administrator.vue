      ...
      <section id="first-tab-group" class="tabgroup">
        <div id="tab1" class=scrollable-div>
          ...
          <div class="kp">
            ...
            <br>
            详细页网址：
            <a style="display: inline" href="https://baike.baidu.com/item/%E9%B2%AB/679608?fromtitle=%E9%B2%AB%E9%B1%BC&fromid=322414">https://baike.baidu.com/item/%E9%B2%AB/679608?fromtitle=%E9%B2%AB%E9%B1%BC&fromid=322414</a>
            <br>
            状态：
            <div style="display: inline"> 已通过</div>
            <br>
          ...
          <div class="kp">
            ...
            <br>
            详细页网址：
            <a style="display: inline" href="https://baike.baidu.com/item/%E9%B2%87/466538?fromtitle=%E9%B2%B6%E9%B1%BC&fromid=1579868">https://baike.baidu.com/item/%E9%B2%87/466538?fromtitle=%E9%B2%B6%E9%B1%BC&fromid=1579868</a>
            <br>
            状态：
            <div style="display: inline"> 已通过</div>
            <br>
        ...
        <div id="tab3" class=scrollable-div>
          <table class="table table-hover   text-center">
            ...
            <tr v-for="mer in merchant" :key="mer.gid">
              <td> {{ mer.gid }}</td>
              <td>{{ mer.name }}</td>
              <td>{{ mer.price }}</td>
              <td>
                <button type="button" class="btn btn-outline-primary" style="font-size: 15px;height: 30px" @click="audit(mer.gid,'yes',mer.remark)">通过</button>
                &nbsp
                <button type="button" class="btn btn-outline-danger" style="font-size: 15px;height: 30px" @click="audit(mer.gid,'no',mer.remark)">不通过</button>
              </td>
        ...
        <div id="tab4" class=scrollable-div>
          <table class="table table-hover   text-center">
            ...
            <tr v-for="msg in message">
              ...
              <td>
                <button type="button" class="btn btn-outline-primary" style="font-size: 20px" @click="reply(msg.mid, msg.reply)">回复</button>
              </td>
            </tr>
            </tbody>
          </table>
