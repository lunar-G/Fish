...
<template>
  <div class="sidebar-navigation hidde-sm hidden-xs">
    ...
    <nav>
      <ul>
        <li style="color: wheat;font-size: 18px" @click="sb()">用户名：</li>
        <li style="color: wheat;font-size: 18px">身份类型：</li>
        <li>
          <a href="#projects">
        ...
        <li style="color: wheat;font-size: 18px" id="leave">退出登录</li>
        ...
        <div class="masonry">
          <div class="row">
            ...
            <div v-for="item in this.recommend.slice(0,1)" class="item">
              <div class="item">
                <div class="col-md-8">
                  <a data-lightbox="image"><img :src="item['imgUrl']" alt=""></a>
                </div>
              </div>
            </div>
    ...
    <section id="featured" class="content-section">
      ...
      <div class="section-content">
        <div class="owl-carousel owl-theme">
          ...
          <!--          <div class="item" v-for="habit in this.habit.slice(1,3)">-->
          <!--            <div class="image">-->
          <!--              <img :src="habit['imgUrl']" alt="">-->
          <!--            </div>-->
          <!--            <div class="text-content">-->
          <!--              <h4 class="text-center">{{ habit['name'] }}</h4>-->
          <!--              <p class="text-justify">{{ habit['introduce'] }}</p>-->
          <!--            </div>-->
          <!--          </div>-->
      ...
      <div class="row">
        ...
        <div class="col-md-4 mb-4 " v-for="item in this.commodity">
          <div class="card">
            ...
            <div>
              <button class="btn btn-primary" style="width: 100px;font-size: 15px">加入购物车</button>
              <button class="btn btn-success m-lg-1" style="width: 100px;font-size: 15px">直接购买</button>
            </div>
          </div>
        </div>
            ...
            <div class="card-body" style="width: 600px">
              ...
              <ul class="list-group">
                <li class="list-group-item d-flex justify-content-between align-items-center" v-for="item in this.cart">
                  ...
                  <button class="btn btn-warning" style="font-size: 18px">删除</button>
                </li>
              </ul>

            </div>
            <button class="btn " style="width: 200px;height: 50px;font-size: 20px;background-color: #1cb25d;color: white">结算</button>
          </div>
        </div>
      </div>
      <br>
            ...
            <div class="card-body" style="width: 600px">
              <ul class="list-group">
                <li class="list-group-item d-flex justify-content-between align-items-center" v-for="o in this.order">
                  ...
                  <button class="btn btn-danger" style="background-color: #45489a;font-size: 18px;">删除</button>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div class="card-body" style="width: 600px">
              <ul class="list-group">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  <label>手机号：{{ this.user.telephone }}</label><br><br>
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  <label>养殖品种：<input type="text" v-model="this.user.cultivated_species" style="background-color:transparent"></label><br><br>
                </li>
                <li>
                  <button class="btn btn-primary" style="font-size: 18px">保存</button>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="section-content">
          <form id="form" action="#" method="post">
            <div class="row">
              <div class="col-md-3">
                <fieldset>
                  <input name="name" type="text" class="form-control" id="name" placeholder="您的姓名..." required="" style="width: 200px">
                </fieldset>
              </div>
              <div class="col-md-3">
                <fieldset>
                  <input name="email" type="email" class="form-control" id="email" placeholder="您的邮箱..." required="" style="margin-left: 30px">
                </fieldset>
              </div>
              <div class="col-md-3">
                <fieldset>
                  <input name="subject" type="text" class="form-control" id="subject" placeholder="主题..." required="" style="width: 300px;margin-left: 80px">
                </fieldset>
              </div>

              <div class="col-md-12">
                <fieldset>
                  <textarea name="message" rows="6" class="form-control" id="message" placeholder="请输入内容..." required=""></textarea>
                </fieldset>
              </div>
              <div class="col-md-12">
                <fieldset>
